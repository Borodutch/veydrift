...
import {Building, Resource, Ship, Technology} from "../src/libraries/VeydriftTypes.sol";
...
contract VeydriftGameTest is Test {
    ...
    function testVanillaResearchCostsScaleByCurrentLevel() public {
        VeydriftGame.Resources memory energy = game.researchCost(player, Technology.Energy);
        ...
        VeydriftGame.Resources memory hyperspaceDrive =
        ...
        VeydriftGame.Resources memory astrophysics =
        ...
        VeydriftGame.Resources memory irn =
        ...
        VeydriftGame.Resources memory graviton = game.researchCost(player, Technology.Graviton);
    ...
    function testResearchPrerequisitesUseVanillaOGameRequirements() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(VeydriftGame.MissingDependency.selector, energyTwoDependency)
        );
        ...
        VeydriftGame.ResearchQueue memory queue = game.researchQueue(player);
    ...
    function testAdvancedResearchPrerequisitesCoverRequestedTechnologies() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                VeydriftGame.MissingDependency.selector, researchLabFourDependency
            )
        );
        ...
        vm.expectRevert(
            abi.encodeWithSelector(VeydriftGame.MissingDependency.selector, hyperspaceDependency)
        );
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                VeydriftGame.MissingDependency.selector, hyperspaceDriveDependency
            )
        );
        ...
        vm.expectRevert(
            abi.encodeWithSelector(VeydriftGame.MissingDependency.selector, irnDependency)
        );
        ...
        vm.expectRevert(
            abi.encodeWithSelector(VeydriftGame.MissingDependency.selector, gravitonDependency)
        );
