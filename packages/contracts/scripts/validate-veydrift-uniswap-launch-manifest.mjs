...
eq(number("auctionEndBlock") - number("auctionStartBlock"), 1800, "auction duration");
eq(number("auctionDurationBlocks"), 1800, "auctionDurationBlocks");
eq(number("auctionDurationMinutesTarget"), 60, "auctionDurationMinutesTarget");
