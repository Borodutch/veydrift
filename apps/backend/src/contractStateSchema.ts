...
export const canonicalContractTables = [
  ...
  "contract_paid_alliance_invite_purchases",
  "contract_paid_alliance_invite_redemptions",
  "contract_paid_alliance_invite_uses",
  "contract_paid_alliance_invite_balances",
