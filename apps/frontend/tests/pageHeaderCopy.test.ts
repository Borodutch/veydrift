...
describe("page headers", () => {
  ...
  test("remove the known redundant screen subtitle copy", () => {
    ...
    for (const removedCopy of [
      ...
      "Enter a Chicken ID to burn it on Base mainnet",
      "Burn a verified Chicken to grant a moon to this planet",
      "same selectable catalog pattern as the planet Shipyard",
      "same selectable catalog and detail controls as the planet Defenses screen",
