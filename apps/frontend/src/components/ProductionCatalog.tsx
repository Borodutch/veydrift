...
function ProductionBuildPlan({ body, context, rows, busy, unknown, ready, error, onRemove, onClear, onConfirm, now }: NonNullable<ProductionCatalogProps<string>["buildPlan"]> & { now: number }) {
