            ...
            <tbody>
              {rows.map((row) => (
                ...
                >
                  ...
                  <MoonStructureLevelInfoCell>{formatDuration(row.durationSeconds)}</MoonStructureLevelInfoCell>
                  <MoonStructureLevelInfoCell>{row.requirements ?? "None"}</MoonStructureLevelInfoCell>
