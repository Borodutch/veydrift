        ...
        params: [
          {
            from: account,
            to: contract,
            data: encodeGameCall("0x6ab2f9d4", [7])
          }
        ]
      },
      {
        ...
        params: [
          {
            from: account,
            to: contract,
            data: encodeGameCall("0x7bd93154", [7])
          }
        ]
      },
      {
        ...
        params: [
          {
            from: account,
            to: contract,
            data: encodeGameCall("0xa5a0d597", [7])
          }
        ]
      },
      {
