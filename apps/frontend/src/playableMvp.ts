...
export const buildingCatalog: Array<{
...
}> = [
  {
    ...
    asset: "/assets/game/buildings/metal-mine-mid.webp",
  },
  {
    key: "crystalMine",
    label: "Crystal Mine",
    baseCost: { metal: 48, crystal: 24, deuterium: 0 },
    asset: "/assets/game/buildings/crystal-mine-mid.webp",
  },
  {
    key: "deuteriumSynthesizer",
    label: "Deuterium Synth",
    baseCost: { metal: 225, crystal: 75, deuterium: 0 },
    asset: "/assets/game/buildings/deuterium-synthesizer-mid.webp",
  },
  {
    key: "solarPlant",
    label: "Solar Plant",
    baseCost: { metal: 75, crystal: 30, deuterium: 0 },
    asset: "/assets/game/buildings/solar-plant-mid.webp",
  },
  {
    key: "roboticsFactory",
  ...
  },
  {
    ...
    asset: "/assets/game/buildings/shipyard-mid.webp",
  },
  {
    key: "researchLab",
    label: "Research Lab",
  ...
  },
  {
    ...
    asset: "/assets/game/buildings/metal-storage-mid.webp",
  },
  {
    key: "crystalStorage",
    label: "Crystal Storage",
    baseCost: { metal: 1_000, crystal: 500, deuterium: 0 },
    asset: "/assets/game/buildings/crystal-storage-mid.webp",
  },
  {
    key: "deuteriumTank",
    label: "Deuterium Tank",
    baseCost: { metal: 1_000, crystal: 1_000, deuterium: 0 },
    asset: "/assets/game/buildings/deuterium-tank-mid.webp",
  },
];
...
export const shipCatalog: Array<{
  ...
  },
  {
    ...
    asset: "/assets/game/ships/light-fighter.webp",
  },
  {
    key: "colonyShip",
    label: "Colony Ship",
    baseCost: { metal: 10_000, crystal: 20_000, deuterium: 10_000 },
    asset: "/assets/game/ships/colony-ship.webp",
  },
];
