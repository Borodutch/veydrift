# VEY-141 OGame Catalog Re-Audit

Date: 2026-05-21

## Sources Checked

- OGame Wiki: Fusion Reactor, cost factor, requirements, Energy Technology scaling, and deuterium consumption:
  https://ogame.fandom.com/wiki/Fusion_Reactor
- OGame Wiki: Nanite Factory construction-time formulas for buildings, ships, and defenses:
  https://ogame.fandom.com/wiki/Nanite_Factory
- OGame Wiki: Formulas, including production time formulas:
  https://ogame.fandom.com/wiki/Formulas
- OGame Wiki: Robotics Factory construction-time effect:
  https://ogame.fandom.com/wiki/Robotics_Factory
- OGame Wiki: ship cost, requirement, structural integrity, cargo, speed, and fuel tables:
  https://ogame.fandom.com/wiki/Ships
- OGame Wiki: defense cost and stat tables:
...
| --- | --- | --- |
| Fusion Reactor frontend level table | The fallback effect row showed generic construction speed. Classic Fusion Reactor converts deuterium into energy and does not speed construction. | Fusion Reactor rows now show energy output and deuterium consumption, with no construction-speed text. |
...
| Fusion Reactor frontend cost growth | Frontend fallback cost scaling used the default 2x facility factor. | Frontend fallback now uses the classic 1.8x Fusion Reactor growth factor. |
...
| Interdimensional Rift Stabilizer | Veydrift-only building for resource token bridge mechanics; not an OGame item. |
| Space Dock repair system | Veydrift combat-recovery mechanic; not treated as a vanilla construction-speed or production building. |
...
| Deuterium Synthesizer temperature formula | Keeps the already-selected Veydrift/OGame approximation using max temperature and basis-point multipliers from the deterministic universe library. |
